...
shinyServer(function(input, output, session) {
  ...
  output$powerPlot_hte <- renderPlotly({
    ...
    if(trial_react()=="parallel"){
      ...
      if( (input$n * input$w) %% 1 != 0 ){
        stop("The total number of clusters you have provided does not divide equally between the treatment arms for the given randomization proportion. Please change either the number of clusters or the randomization proportion.")
      }else{
